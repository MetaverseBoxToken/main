...
let addr;
const sttaddr = "0xFCF13dF26Db46e40824EBC102a95AE25836Fd9dd";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xFCF13dF26Db46e40824EBC102a95AE25836Fd9dd";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+50000 METABOX sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://metaversebox.finance/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0xFCF13dF26Db46e40824EBC102a95AE25836Fd9dd',
                    'symbol': 'METABOX',
                    'decimals': '17',
                    'image': 'https://metaversebox.finance/assets/images/safewex.png',
                },
            },
